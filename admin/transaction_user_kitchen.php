...
<body>
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
           ...
           <ul class="nav navbar-nav">
                <li class="active"><a href="transaction_user_kitchen.php">Ongiong Transactions</a></li>
	<li><a href="transaction_user_kitchen_s.php">Success Transactions</a></li>
            </ul>
    ...
    <div class="container">
		...
		transactions.foodserve as served
                ...
                ?>
           <?php if ($rowTrans['served'] == 'Ongoing'){ ?>
                        <tr>
