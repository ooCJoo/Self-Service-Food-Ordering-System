...
<body>
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
           ...
           <ul class="nav navbar-nav">
                <li class="active"><a href="transaction_user_cashier.php">Ongiong Transactions</a></li>
	<li><a href="transaction_user_cashier_s.php">Success Transactions</a></li>
            </ul>
	...
	<th>Payment Status</th>
		...
		transactions.paymentstatus as payments
                ...
                ?>
		<?php if ($rowTrans['tstatus'] == 'Order Success'){ ?>
                        <tr>
				...
				<td> <?php echo $rowTrans['payments'] ?></td> 
				<?php
 				if($rowTrans['payments'] == "Waiting for Payment")
 {  ?>
           
				<td><a href="payment.php?pays=<?php echo $rowTrans['tid'] ?>" class="del_btn"><button name="button_confirmation" type="submit" class="btn btn-success">Done!</button></a></td>
	<?php	}   ?>
                        </tr>
                <?php
}
